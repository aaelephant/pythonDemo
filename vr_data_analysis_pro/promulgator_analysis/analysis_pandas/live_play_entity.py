...
class LivePlayEntity(object):
	"""docstring for Entity"""

	def __init__(self, class_name, columns, **kwargs):
		super(LivePlayEntity, self).__init__()
	...
	def __getattribute__(self, key):
		entity = super(LivePlayEntity, self).__getattribute__("_entity")
		try:
			return super(LivePlayEntity, self).__getattribute__(key)
		except:
			print '(get except)'
	...
	def __setattr__(self, key, value):
		if key == "_entity":
			super(LivePlayEntity, self).__setattr__("_entity", value)
			return
		entity = super(LivePlayEntity, self).__getattribute__("_entity")
		try:
...
if __name__ == '__main__':
	...
	entity = LivePlayEntity("user", "", **user)
	print entity
	# print dir(entity)
